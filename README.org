...
Signature:
#+begin_src lisp
  function-lambda-expression* function-or-macro-designator &optional force => list, list, symbol, list
  ;; Alias:
  lambda-expression* function-or-macro-designator &optional force => list, list, symbol, list
#+end_src
