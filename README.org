...
documentation.lisp also defines more =documentation= methods (and respective =setf= method) to simplify documentation fetching and setting:
- =(symbol (eql t))=
- =(standard-object t)=
- =(structure-object t)=
- =(t (eql 'package))= (a new one for package documentation convenience)
