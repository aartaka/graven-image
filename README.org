...
A simple benchmarking macro that runs its body N times (defaulting
to 1000) and prints aggregate statistics for total time/resources
spent and statistics per call.
