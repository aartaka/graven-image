...
#+begin_quote
This is an interactive inspector for #<READTABLE {1000022513}>
Available commands are:
?              Print a list of commands
HELP           Print a list of commands
LENGTH         (:LENGTH NEW-LENGTH) Change the page size
WIDTH          (:WIDTH NEW-LENGTH) Change the page size
NEXT-PAGE      Show the next page of properties (if any)
PREVIOUS-PAGE  Show the previous page of properties (if any)
HOME           Scroll back to the first page of properties
RESET          Scroll back to the first page of properties
TOP            Scroll back to the first page of properties
SET            (:SET PROPERTY VALUE) Set the PROPERTY to VALUE.
MODIFY         (:MODIFY PROPERTY VALUE) Set the PROPERTY to VALUE.
...
UP             Move to the previous/upper inspected object or exit the inspector
POP            Move to the previous/upper inspected object or exit the inspector
BACK           Move to the previous/upper inspected object or exit the inspector
INSPECT        (:INSPECT KEY) Inspect the object under KEY
ISTEP          (:ISTEP KEY) Inspect the object under KEY
EVALUATE       (:EVALUATE FORM) Evaluate the FORM
