...
(defgeneric describe* (object &optional stream ignore-methods)
  (:method (object &optional (stream t) ignore-methods)
    (let* ((stream (etypecase stream
      ...
      (if (typep stream 'string-stream)
          ...
          (values))))
  (:documentation "Display OBJECT information to a STREAM.
